      ...
      <div class="menu-space">
        <div class="content">
          ...
          <ul class="cl-vnavigation">
            <li><a href="<? echo base_url(); ?>admin"><i class="fa fa-home"></i><span>Dashboard</span></a></li>
            <li><a href="#"><i class="fa fa-home"></i><span>Estates</span></a></li>
            <li><a href="#"><i class="fa fa-home"></i><span>Buildings</span></a></li>
            <li><a href="#"><i class="fa fa-home"></i><span>Houses</span></a></li>
            <li><a href="#"><i class="fa fa-home"></i><span>Settings</span></a>
              <ul class="sub-menu">
